...
import { Barcode, Plus, Printer, Tag } from 'lucide-react';
  ...
  return (
    <div className="mt-2 border border-dashed border-slate-200 rounded-xl p-4 bg-white shadow-sm ring-1 ring-slate-900/5">
      <div className="flex items-center justify-between mb-3 border-b border-slate-100 pb-2">
        ...
        <span className="badge-brand text-[10px] uppercase tracking-wider">
          Active Unit
        </span>
      </div>
...
export default function Barcodes() {
  ...
  return (
    <div className="space-y-5 page-stagger">
      <PageHeader icon={Barcode} title="Barcodes" subtitle="Design, preview, and print blood unit labels" />

      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
      <div className="lg:col-span-5 space-y-4">
        <div className="card-3d overflow-hidden scroll-reveal">
          <div className="bg-gradient-to-r from-brand-50/50 to-white border-b border-slate-100 p-4 flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <button
                type="button"
                className={`btn-secondary ${!selectedLabel ? 'opacity-50 pointer-events-none' : ''}`}
              ...
              return (
                <div
                  ...
                  className={`group relative flex items-center justify-between border rounded-xl px-4 py-3 transition-all cursor-pointer ${
                    isActive 
                      ? 'border-brand-500 ring-2 ring-brand-500/10 bg-brand-50/40 shadow-sm' 
                      : 'border-slate-100 bg-white hover:border-slate-300 hover:bg-slate-50 card-interactive'
                  }`}
      ...
      >
        ...
        >
          ...
          <div className="flex gap-2 justify-end pt-4 border-t border-slate-100">
            ...
            <button className="btn-primary px-8" type="submit">
